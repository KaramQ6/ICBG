        ...
        <>
            ...
            >
                ...
                <div className="h-full flex flex-col">
                    <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-gray-900/40">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                onClick={onClose}
                            >
                                <MediaItem item={selectedItem} className="w-full h-full object-contain bg-gray-950" onClick={onClose} />
                                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 md:p-6 
                                              bg-gradient-to-t from-black via-black/70 to-transparent">
                                    <h3 className="text-white text-base sm:text-lg md:text-xl font-serif italic text-shadow-premium">
                                        {selectedItem.title}
                                    </h3>
                                    <p className="text-[#C8B1CC] text-xs sm:text-sm mt-2 leading-relaxed">
                                        {selectedItem.desc}
                                    </p>
                                </div>
                            </motion.div>
                ...
                {/* Close Button */}
                <motion.button
                    className="absolute top-4 right-4 p-2.5 rounded-full bg-[#3a1d42]/90 border border-white/10 text-white hover:border-[#f8b146]/40 hover:text-[#f8b146] transition-all backdrop-blur-sm cursor-pointer shadow-lg"
                    onClick={onClose}
            ...
            <motion.div
                ...
                className="fixed z-[110] left-1/2 bottom-6 -translate-x-1/2 touch-none"
            >
                <motion.div
                    className="relative rounded-2xl bg-[#3a1d42]/75 backdrop-blur-xl 
                        ...
                        {mediaItems.map((item, index) => (
                            <motion.div
                                ...
                                className={`
                                    ...
                                    ${selectedItem.id === item.id
                                        ? 'ring-2 ring-[#f8b146] shadow-[0_0_15px_rgba(248,177,70,0.4)]'
                            ...
                            >
                                ...
                                {selectedItem.id === item.id && (
                                    <motion.div
                                        layoutId="activeGlow"
                                        className="absolute -inset-2 bg-gradient-to-r from-[#f8b146]/20 to-[#f28a75]/20 blur-xl"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-5xl">
            <div className="mb-12 text-center">
                <motion.h1
                    className="text-3xl sm:text-4xl md:text-5xl font-sans font-black bg-clip-text text-transparent 
                             bg-gradient-to-r from-white via-[#C8B1CC] to-white"
                ...
                <motion.p
                    className="mt-4 text-sm sm:text-base font-serif italic text-[#C8B1CC]"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                className={`relative overflow-hidden rounded-3xl cursor-grab active:cursor-grabbing border border-white/5 bg-[#3a1d42]/20 hover:border-[#f8b146]/30 transition-all ${item.span}`}
                            ...
                            >
                                ...
                                >
                                    ...
                                    <h3 className="relative text-white text-xs sm:text-sm font-serif italic line-clamp-1">
                                        {item.title}
                                    </h3>
                                    <p className="relative text-[#C8B1CC] text-[10px] sm:text-xs mt-1 line-clamp-2 leading-relaxed">
                                        {item.desc}
                                    </p>
                                </motion.div>
                            </motion.div>
